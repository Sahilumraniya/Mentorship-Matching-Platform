...
const UserCard = ({
    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-4 mb-4 md:flex flex-row justify-between">
            ...
            <div className="flex md:flex-col gap-3 justify-end">
                {showSendRequestButton && (
                    <button
                        ...
                        className="bg-blue-500 text-white rounded p-2 md:px-4 md:py-2 flex items-center mb-2"
                    >
