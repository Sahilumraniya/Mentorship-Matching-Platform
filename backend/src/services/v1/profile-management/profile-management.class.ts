...
import { profilePath } from '../../../service_endpoints/services';
import { Profile } from '../../../db_services/v1/profile/profile.class';
...
export class ProfileManagement implements ServiceMethods<Data> {
  app: Application;
  options: ServiceOptions;
  service: Profile & ServiceAddons<any>;

  constructor(options: ServiceOptions = {}, app: Application) {
    this.options = options;
    this.app = app;
    this.service = app.service(profilePath);
  }
